describe('Login Tests', () => {
      ...
      it('1.1.1[N] Try: Wrong username and Wrong password', () => {
        require('cypress-xpath');
      ...
      it("1.1.2[N] Try: Wrong username and Correct password", () => {
        // Visit the website
        cy.visit('https://inv.bg')
      ...
      it("1.1.3[N] Try: Correct username and Wrong password", () => {
        // Visit the website
        cy.visit('https://inv.bg')
      ...
      it("1.1.4[N] Try: Empty fields username and password", () => {
        // Visit the website
        cy.visit('https://inv.bg')
      ...
      it("1.1.5[N] Try: Empty field username and correct password", () => {
        // Visit the website
        cy.visit('https://inv.bg')
      ...
      it("1.1.6[N] Try: Correct username and  Empty field password", () => {
        // Visit the website
        cy.visit('https://inv.bg')
      ...
      it('2.[P] Perform LogIn and LogOut', () => {
        require('cypress-xpath');
